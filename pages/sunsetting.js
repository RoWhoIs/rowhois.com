        ...
        <>
            ...
            <div className="legal-content">
                ...
                <section>
                    ...
                    <br />
                    <p>For obvious reasons, that isn't a healthy habit. And it tore at me. I'm currently looking for a better maintainer of the project who will keep it running and improving it. If you would like to own RoWhoIs, email me at <a href={"developers@rowhois.com"}>developers@rowhois.com</a>. Note you have to be over 18 (because of the bot monetization features).</p>
                    <br />
                    ...
                    <br />
                    <p>And any RoWhoIs+ subscribers, thanks for supporting me. If you'd like a refund on your purchase, you can reach out to <a href={"support@rowhois.com"}>support@rowhois.com</a>. I hope that if there is a next maintainer of RoWhoIs, they do a good job and keep the community happy. </p>
                    <br />
